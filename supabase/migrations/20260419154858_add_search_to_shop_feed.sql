...
grant execute on function public.get_shop_feed(double precision, double precision, uuid, double precision, text, text, numeric, numeric, text, int, timestamptz) to anon, authenticated;