...
export default function Conversation() {
  ...
  const handleOpenBuyerRating = async () => {
    if (!conversation) return;
    setBuyerRatingVisible(true);
  };
      ...
      return (
        <View>
          ...
          <TouchableOpacity
            ...
            onPress={() => isBuyer ? handleOpenBuyerRating() : undefined}
      ...
      <SafeAreaView style={styles.container} edges={['top']}>
        ...
        <View style={styles.header}>
          ...
          <TouchableOpacity
            onPress={() => {
              if (!conversation.other_user_id) return;
              router.push(`/profile/${conversation.other_user_id}`);
            }}
            activeOpacity={conversation.other_user_id ? 0.7 : 1}
          ...
          {/* Name + status — tappable to profile */}
          <TouchableOpacity
          ...
          >
            <Text
              style={[
                styles.headerName,
                conversation.other_user_id === null && styles.deletedHeaderName,
              ]}
              numberOfLines={1}
            >
              {conversation.other_user_id === null
                ? 'Account Deleted'
        ...
        >
          ...
          <View style={styles.listingInfo}>
            <Text
              style={[
                styles.listingTitle,
                !conversation.listing_title && styles.deletedContextTitle,
              ]}
              numberOfLines={1}
            >
              {conversation.listing_title || 'Listing Unavailable'}
            </Text>
        ...
        {conversation && (
          <BuyerRatingModal
            ...
            onClose={() => setBuyerRatingVisible(false)}
